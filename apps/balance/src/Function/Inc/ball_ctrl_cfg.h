...
#ifndef BALL_CTRL_CALIBRATION_FRAMES
#define BALL_CTRL_CALIBRATION_FRAMES (8u)
#endif
#ifndef BALL_CTRL_CALIBRATION_MAX_SPREAD_MM
#define BALL_CTRL_CALIBRATION_MAX_SPREAD_MM (3)
#endif
